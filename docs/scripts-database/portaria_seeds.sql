...
INSERT INTO moradores (nome, cpf, telefone, email, ativo, dt_aceite_lgpd, foto, dt_foto_validade, biometria, dt_biometria_validade, codigo_condominio) VALUES
    ...
    ('Sergio Ramos Pereira',    '96385274100','83977665544','sergio.ramos@email.com',    FALSE, NULL,                 NULL, NULL,         NULL, NULL, 'COND-001');

-- 3.2 — Residencias
INSERT INTO residencias (codigo_condominio, numero_residencia, bloco, quadra, andar, tipo_moradia, interfone, observacao) VALUES
    ...
    ('COND-001','402','B',   NULL, 4,'apartamento','402', NULL);

-- 3.3 — Vínculos morador x residência
INSERT INTO morador_residencia (morador_id, residencia_id, tipo_morador, dt_inicio, codigo_condominio) VALUES
    ...
    (4, 4, 'proprietario', '2023-03-15', 'COND-001');
