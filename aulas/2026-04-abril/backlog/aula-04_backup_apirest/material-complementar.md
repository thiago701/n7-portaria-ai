...
- **Exemplo básico:**
  ...
  curl -X POST http://localhost:5000/api/moradores \
    ...
    -d '{"nome":"João","cpf":"123.456.789-00","numero_residencia":"101","email":"joao@email.com"}'
  ```
...
- **Aula 05 (30/04)**: Interface Gráfica com CustomTkinter — A vitrine do sistema
- **Fase 2 (Maio)**: Cadastro de Visitantes, SQL JOINs, Entrada/Saída, Login do Porteiro
