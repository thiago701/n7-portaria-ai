...
# Caminho do banco de dados (será criado na pasta database/)
caminho_banco = "../database/portaria.db"
...
def inserir_morador(conexao, nome, cpf, apartamento, bloco, telefone, email):
    """
    Insere um novo morador na tabela.

    TODO: Escreva o comando SQL INSERT INTO que adiciona um registro.
    As colunas são: nome, cpf, apartamento, bloco, telefone, email
    ...
    try:
        cursor.execute(sql, (nome, cpf, apartamento, bloco, telefone, email))
        conexao.commit()
        return True
...
def main():
    ...
    if moradores:
        ...
        for morador in moradores:
            ...
            apto_morador = morador['apartamento']
