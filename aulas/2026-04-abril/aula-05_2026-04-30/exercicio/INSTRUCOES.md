...
## Passo 2 — Entender a Estrutura do Arquivo

Abra o arquivo `portaria_gui.py`. Ele já tem a estrutura básica:
...
## Passo 3 — Completar o TODO 1: Criar os Campos do Formulário
...
## Passo 4 — Completar o TODO 2: Cadastrar Morador no Banco
...
```python
cursor.execute("INSERT INTO moradores (nome, cpf, apartamento, ...) VALUES (?, ?, ?, ...)",
               (nome, cpf, apartamento, ...))
```

---

## Passo 5 — Completar o TODO 3: Carregar e Exibir Moradores
...
- Verifique se o arquivo `portaria.db` existe na pasta certa
