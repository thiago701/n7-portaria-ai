...
| TIMESTAMP | Data e hora | 2026-04-09 14:30:00 |
...
```sql
-- Se você disse:
INSERT INTO moradores (nome, cpf, numero_residencia) VALUES (?, ?, ?)
...
- Liste moradores com numero_residencia acima de 200
...
- **Aula 03 (16/04)**: CRUD Completo — As 4 operações mágicas em Python + SQLite
- **Aula 04 (23/04)**: API REST — Primeira rota com Flask
- **Aula 05 (30/04)**: Interface Gráfica — GUI com CustomTkinter
