...
5. **Relatório por apartamento:** Crie uma função que lista todos os moradores de um apartamento específico.
...
- **Aula 04:** Validações mais avançadas (email, telefone, etc)
- **Aula 05:** Relatórios e estatísticas
- **Aula 06:** Interface gráfica (ao invés de menu de texto)
- **Aula 07:** Integração com múltiplas tabelas
